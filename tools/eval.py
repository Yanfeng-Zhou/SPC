...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_path', default='/mnt/data1/SPC/seg_pred/test/P-CT/best_result2_Jc_0.7301')
    parser.add_argument('--mask_path', default='/mnt/data1/SPC/dataset/P-CT/val/mask')
